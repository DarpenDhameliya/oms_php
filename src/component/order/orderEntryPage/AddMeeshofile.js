...
import { MesshoSlice, Messhostatus, Messhostate } from "./slice/MesshoSlice";
  ...
  const handleopenrecord = () => {
    if(navigator.onLine == true){
      ...
      if(extension !== 'pdf' || messhotfetch.length === 0){
        ...
        dispatch(MesshoSlice({ file: messhotfetch }));
      }
    } else {
      setModelOpen(1);
        setModelcount(2);
