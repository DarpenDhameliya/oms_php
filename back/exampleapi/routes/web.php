...
Route::any('post-orderEntry', [OrderController::class, 'insert_orderentry'])->name('orderEntry.post');
...
Route::get('Order_Return', [OrderController::class, 'order_return'])->name('order_return');
Route::post('get_returndata', [OrderController::class, 'get_returndata'])->name('get_returndata.post'); 
Route::post('insert_returndata', [OrderController::class, 'insert_returndata'])->name('insert_returndata.post'); 
