...
class ProductController extends Controller
{
    ...
    public function productlist()
    {
        if (Auth::check()) {
            ...
            $data['product']=Product::select('product.id as p_id','product.name','product.*','unit.*','gst.*')->join('unit','unit.id','=','product.unit_id')->join('gst','gst.id','product.gst_id')->where('user_id', $user->id)->get();
